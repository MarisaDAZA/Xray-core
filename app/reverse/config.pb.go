...
type PortalConfig struct {
	...
	Tag              string                 `protobuf:"bytes,1,opt,name=tag,proto3" json:"tag,omitempty"`
	Domain           string                 `protobuf:"bytes,2,opt,name=domain,proto3" json:"domain,omitempty"`
	HeartbeatPeriod  uint32                 `protobuf:"varint,4,opt,name=heartbeatPeriod,proto3" json:"heartbeatPeriod,omitempty"`
	HeartbeatPadding uint32                 `protobuf:"varint,5,opt,name=heartbeatPadding,proto3" json:"heartbeatPadding,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *PortalConfig) GetHeartbeatPeriod() uint32 {
	if x != nil {
...
func (x *PortalConfig) GetHeartbeatPadding() uint32 {
	if x != nil {
...
const file_app_reverse_config_proto_rawDesc = "" +
	...
	"\x06domain\x18\x02 \x01(\tR\x06domain\"\x8e\x01\n" +
	"\fPortalConfig\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12\x16\n" +
	"\x06domain\x18\x02 \x01(\tR\x06domain\x12(\n" +
	"\x0fheartbeatPeriod\x18\x04 \x01(\rR\x0fheartbeatPeriod\x12*\n" +
	"\x10heartbeatPadding\x18\x05 \x01(\rR\x10heartbeatPadding\"\x92\x01\n" +
	"\x06Config\x12C\n" +
